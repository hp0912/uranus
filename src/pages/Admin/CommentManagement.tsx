...
// 样式
import '../../components/UranusComment/comment.css';
...
export const CommentManagement: FC = () => {
  ...
  const columns: ColumnsType<ICommentEntity> = [
    {
      ...
      ellipsis: true,
      render: (text: string) => {
        return <div className="uranus-comment-container" dangerouslySetInnerHTML={{ __html: text }} />;
      },
    },
    {
      title: '类别',
