...
export const routeConfig: IRouteConfig[] = [
  ...
  { title: '博客编辑', path: '/article/edit/:articleId', exact: true, component: 'ArticleEditPage' },
  { title: '博客详情', path: '/article/detail/:articleId', exact: true, component: 'ArticleDetail' },
