declare const styles: {
  ...
  readonly "uranusMenuContainerLeft": string;
  readonly "uranusMenuContainerRight": string;
  readonly "uranusHeaderLoginContainer": string;
  readonly "uranusHeaderLogin": string;
  readonly "uranusHeaderRegister": string;
