...
/*让我们给它加一个边框吧*/
#uranus_about_us_code {
  border: 2px solid #00FF1B;
  padding: 20px;
}
/*代码看不清楚？来点高亮吧！*/
#uranus_about_us_container .token.selector {
  color: #a6e22e;
}
#uranus_about_us_container .token.property {
  color: #f92672;
}
#uranus_about_us_container .token.punctuation {
  color: #f8f8f2;
}
#uranus_about_us_container .token.function {
  color: red;
}
#uranus_about_us_code {
  color: #f8f8f2;
